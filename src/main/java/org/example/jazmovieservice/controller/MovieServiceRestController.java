package org.example.jazmovieservice.controller;

import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.responses.ApiResponse;
import io.swagger.v3.oas.annotations.responses.ApiResponses;
import org.example.jazmovieservice.model.Movie;
import org.example.jazmovieservice.service.MovieService;
...
public class MovieServiceRestController {
    ...
    @Operation(summary = "Get movie by ID", description = "Returns movie with given ID")
    @ApiResponses(value = {
